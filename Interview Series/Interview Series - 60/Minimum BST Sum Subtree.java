// { Driver Code Starts
    ...
    */
    ...
    class Solution {
        ...
        public static Nodes minSubtree(Node root, int target) {
            if (root == null) {
                Nodes p = new Nodes();
            ...
            Nodes left = minSubtree(root.left, target);
            Nodes right = minSubtree(root.right, target);
